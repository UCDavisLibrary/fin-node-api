...
class Service {
   ...
   * @param {String} options.url url template (AuthenticationService or ClientService).  ex: http://cas:8000
  ...
  async create(options) {
    ...
    } else if( options.type === this.TYPES.AUTHENTICATION || options.type === this.TYPES.CLIENT ) {
