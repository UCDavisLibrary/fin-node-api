...
class Service {
  ...
  constructor(api) {
    ...
    this.TYPES = {PROXY, FRAME, WEBHOOK, EXTERNAL, AUTHENTICATION, CLIENT, TRANSFORM}
    this.ROOT = ROOT;
   ...
   * @param {String} options.type either [ProxyService|FrameService|TransformService|ExternalService|WebhookService|AuthenticationService]
